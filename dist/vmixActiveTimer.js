...
let lastActive = null; // Last known active input
let activeStartTime = 0; // Start time for the active input
let activeDisplay = null; // Element to display the active input
let timerDisplay = null; // Element to display the timer
let retryDelay = POLL_INTERVAL; // Initial retry delay in milliseconds
const maxRetryDelay = 60000; // Maximum retry delay (1 minute)
let pollingInterval = null; // Reference to the polling interval
...
function getInputName(xmlDoc, activeNumber) {
